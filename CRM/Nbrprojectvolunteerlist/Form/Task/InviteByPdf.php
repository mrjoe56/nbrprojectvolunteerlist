...
class CRM_Nbrprojectvolunteerlist_Form_Task_InviteByPdf extends CRM_Contact_Form_Task {
  ...
  public function preProcess() {
    ...
    CRM_Nbrprojectvolunteerlist_Form_Task_InviteLetterCommon::preProcess($this);
    ...
    if ($cid) {
      CRM_Nbrprojectvolunteerlist_Form_Task_InviteLetterCommon::preProcessSingle($this, $cid);
      $this->_single = TRUE;
    }
    else {
      parent::preProcess();
  ...
  public function setDefaultValues() {
    ...
    $defaults = $defaults + CRM_Nbrprojectvolunteerlist_Form_Task_InviteLetterCommon::setDefaultValues();
    return $defaults;
  }
  ...
  public function buildQuickForm() {
    ...
    CRM_Nbrprojectvolunteerlist_Form_Task_InviteLetterCommon::buildQuickForm($this);
  }
  ...
  public function postProcess() {
    CRM_Nbrprojectvolunteerlist_Form_Task_InviteLetterCommon::postProcess($this);
  }
