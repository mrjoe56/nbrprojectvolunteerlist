...
<table class="form-layout-compressed">
    <tr>
      <td class="label-left">
        {$form.template.label}
        {help id="template" title=$form.template.label file="CRM/Nbrprojectvolunteerlist/Form/Task/InviteLetterCommon.hlp"}
      </td>
      <td>
...
<div class="crm-accordion-wrapper collapsed crm-pdf-format-accordion">
    ...
    <table class="form-layout-compressed">
      <tr>
        <td class="label-left">{$form.format_id.label} {help id="id-pdf-format" file="CRM/Nbrprojectvolunteerlist/Form/Task/InviteLetterCommon.hlp"}</td>
